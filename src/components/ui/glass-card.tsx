...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-glass-border bg-glass backdrop-blur-glass shadow-xl",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-4xl md:text-6xl font-bold leading-none tracking-tight text-foreground",
      className
    )}
    {...props}
  />
